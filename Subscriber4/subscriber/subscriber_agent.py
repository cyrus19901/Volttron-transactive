...
def subscriber_agent(config_path, **kwargs):
    ...
    class Subscriber(Agent):
        ...
        def on_match(self, peer, sender, bus, topic, headers, message):
            ...
            '''
            if (topic == "devices/AVISTA/SellingAmount"):
                file = open('/home/rajveer-2/Desktop/volttron/data/AVISTA_SellingAmount.txt','w')
                file.write(str(message))
                print("SellingAmount", message)

                file.close()
            if (topic == "devices/AVISTA/AskingPrice"):
                file = open('/home/rajveer-2/Desktop/volttron/data/AVISTA_AskingPrice.txt','w')
                file.write(str(message))
